...
//        System.out.println(Arrays.toString(c));
        ...
        int[] test = {1,2,3,4,5};
        // int[] -> Integer[]
        Integer[] IntegerTest = Arrays.stream(test).boxed().toArray(Integer[]::new);

        // Integer[] -> List<Integer>
        List<Integer> list2 = new ArrayList<>(List.of(IntegerTest));
        Collections.reverse(list);

        Integer[] c = list2.toArray(Integer[]::new);
